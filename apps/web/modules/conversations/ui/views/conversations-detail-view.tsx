...
import { ConversationDetailViewSkeleton } from '@/modules/conversations/ui/views/conversations-detail-view-skeleton';

type ConversationsDetailViewAttributes = {
...
export const ConversationsDetailView = ({
  conversationId
}: ConversationsDetailViewAttributes) => {
